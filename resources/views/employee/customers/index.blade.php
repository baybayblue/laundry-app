    ...
    <div class="col-12 col-md-8">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <p class="mb-0 text-muted small">Kelola data pelanggan untuk operasional laundry</p>
            </div>
        </div>
    </div>
    <div class="col-12 col-md-4 text-md-end">
        <a href="{{ route('employee.customers.create') }}" class="btn btn-success d-inline-flex align-items-center gap-2 shadow-sm rounded-pill px-4">
...
<div class="card border-0 shadow-sm rounded-4 mb-3">
    <div class="card-body p-3">
        <form method="GET" action="{{ route('employee.customers.index') }}" class="row g-2 align-items-center">
            ...
            <div class="col-12 col-md-2 d-flex gap-2">
                ...
                <a href="{{ route('employee.customers.index') }}" class="btn btn-light btn-sm rounded-pill" title="Reset Pencarian">
                    <i class="ti ti-x"></i>
                </a>
                @endif
            </div>
                    ...
                    <tr class="customer-row" style="transition: background .15s;">
                        ...
                        <td class="pe-4 text-end">
                            <div class="d-flex align-items-center justify-content-end gap-1">
                                ...
                                <form action="{{ route('employee.customers.destroy', $customer) }}" method="POST" class="d-inline form-delete">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button"
                        ...
                        <td colspan="6" class="text-center py-5">
                            <div class="py-4">
                                ...
                                <p class="small text-muted mb-3">
                                    ...
                                    @else
                                        Tambahkan pelanggan pertama Anda untuk memulai operasional.
                                    @endif
                                </p>
                                @if(request()->has('search') && request('search') != '')
                                    <a href="{{ route('employee.customers.index') }}" class="btn btn-light btn-sm rounded-pill px-4">
                                        <i class="ti ti-x me-1"></i>Reset Pencarian
                                    </a>
                                @else
                                    <a href="{{ route('employee.customers.create') }}" class="btn btn-success btn-sm rounded-pill px-4">
