                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-center gap-2 p-3 rounded-3" style="background:#0d6efd10; border: 1px dashed #0d6efd60;">
                                ...
                                <div class="small">
                                    Jika email diisi, pelanggan dapat menggunakannya untuk login. Kata sandi otomatis diset ke: <code class="fw-bold bg-primary bg-opacity-10 px-2 py-1 rounded text-primary">password</code>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-body p-4">
                ...
                <ul class="list-unstyled small text-muted mb-0 d-flex flex-column gap-3">
                    <li class="d-flex align-items-start gap-2">
                        ...
                        <span><strong>Nama Pelanggan</strong> wajib diisi untuk identifikasi pada nota laundry.</span>
                    </li>
                    <li class="d-flex align-items-start gap-2">
                        <i class="ti ti-circle-check text-success mt-1 flex-shrink-0"></i>
                        <span>Jika Anda mengisi <strong>Email</strong>, pastikan email tersebut valid dan belum digunakan pelanggan lain.</span>
                    </li>
                    <li class="d-flex align-items-start gap-2">
                        <i class="ti ti-circle-check text-success mt-1 flex-shrink-0"></i>
                        <span><strong>Nomor HP</strong> disarankan untuk diisi memudahkan staf kurir saat pengantaran.</span>
                    </li>
                    <li class="d-flex align-items-start gap-2">
                        <i class="ti ti-circle-check text-success mt-1 flex-shrink-0"></i>
                        <span>Isi <strong>Alamat</strong> selengkap mungkin dengan petunjuk jalan (opsional tapi sangat disarankan).</span>
                    </li>
                </ul>
            </div>
        </div>
            ...
            if (el.tagName === 'INPUT' || el.tagName === 'TEXTAREA') {
                if (el.checkValidity()) {
                    if (el.value.length > 0) {
                        ...
                        // if empty and not required, just clear valid classes
                        el.classList.remove('is-invalid');
